...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../multicore.sopcinfo
...
# Design Name 
# setting SOPC_NAME is multicore
SOPC_NAME := multicore
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4001048
SOPC_SYSID_FLAG += --sidp=0x4001048
ELF_PATCH_FLAG  += --sidp 0x4001048

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1494889510
SOPC_SYSID_FLAG += --timestamp=1494889510
ELF_PATCH_FLAG  += --timestamp 1494889510
